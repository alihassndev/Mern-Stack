    ...
    <footer className="bg-gray-800 text-white py-10">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">FoodSave</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/guidelines" className="text-gray-300 hover:text-white">Food Safety</Link></li>
        ...
        <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">&copy; {new Date().getFullYear()} FoodSave. All rights reserved.</p>
