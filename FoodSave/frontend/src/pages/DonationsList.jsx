      ...
      <div className="max-w-7xl mx-auto">
        ...
        {donations.length === 0 ? (
          <div className="bg-gray-50 rounded-lg p-8 text-center">
            <h3 className="text-xl font-medium text-gray-700 mb-2">No donations available</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {donations.map((donation) => (
              <div key={donation._id} className="bg-white rounded-lg shadow-md overflow-hidden">
                ...
                <div className="p-4">
                  <h3 className="text-xl font-semibold mb-2">{donation.foodName}</h3>
                  ...
                  <div className="flex justify-between items-center">
                    <span className={`px-2 py-1 rounded-full text-xs ${donation.status === "available" ? "bg-green-100 text-green-800" : "bg-yellow-100 text-yellow-800"}`}>
                    ...
                    {user?.role === "ngo" && donation.status === "available" && (
                      <button
                        ...
                        onClick={() => {
                          // Will implement pickup request functionality
                        }}
                      >
                        Request Pickup
                      </button>
